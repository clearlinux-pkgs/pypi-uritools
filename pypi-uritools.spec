...
Source0  : https://files.pythonhosted.org/packages/36/b1/e482d43db3209663b82a59e37cf31f641254180190667c6b0bf18a297de8/uritools-5.0.0.tar.gz
...
%prep
%setup -q -n uritools-5.0.0
cd %{_builddir}/uritools-5.0.0
pushd ..
cp -a uritools-5.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746224873
...
cp %{_builddir}/uritools-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-uritools/bd038e2fe6c05c8469710b7d32881deb3ad9bb7d || :
...
/usr/share/package-licenses/pypi-uritools/bd038e2fe6c05c8469710b7d32881deb3ad9bb7d
